...
import NpcObjectRow from "./npc_object_table";
...
const tablesSchema = __schema({
  npc_object: __table({
    name: 'npc_object',
    indexes: [
      { accessor: 'id', name: 'npc_object_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
    ],
    constraints: [
      { name: 'npc_object_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, NpcObjectRow),
});
...
const reducersSchema = __reducers(
  ...
  __reducerSchema("increment_talk_count", IncrementTalkCountReducer),
